...
export class MiraContextFile extends ContextFile {
  public readonly filename = 'MIRA.md'
  public readonly ttlMs = null

  public generate(): string {
    return [
      '> Who I am, how I work, and how I use memory. I am Mira, your personal assistant.',
      '# MIRA',
